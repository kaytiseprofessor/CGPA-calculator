  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 font-sans text-gray-800 dark:text-gray-100 transition-colors duration-300">
        ...
        {/* Small padding (px-2) on mobile to allow maximum width for inputs */}
        <main className="flex-grow container mx-auto px-2 sm:px-4 py-4 md:py-8 max-w-6xl">
          {view === 'calculator' ? (
            <>
              {/* Hero */}
                ...
                <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-6">
                  ...
                  <div className="flex justify-start lg:justify-end">
                    <button 
                      ...
                      className="bg-white dark:bg-gray-800 text-emerald-700 dark:text-emerald-400 border border-gray-200 dark:border-gray-700 px-4 py-2.5 rounded-lg text-xs sm:text-sm font-semibold shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-all flex items-center justify-center gap-2 active:scale-95 w-full sm:w-auto"
                    >
