  ...
  return (
    <header className="bg-emerald-700 dark:bg-emerald-900 text-white shadow-lg transition-colors duration-300 sticky top-0 z-30">
      <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-3 bg-emerald-800/50 dark:bg-emerald-950/50 p-1 rounded-xl backdrop-blur-sm">
          <button
        ...
        <button 
          onClick={toggleTheme}
          className="absolute right-4 top-4 md:static p-2 rounded-lg bg-emerald-600 dark:bg-emerald-800 hover:bg-emerald-500 dark:hover:bg-emerald-700 transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-300 shadow-sm"
